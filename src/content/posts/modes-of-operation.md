...
description: Frameworks to help you make decisions
date: 2025-11-17
tags:
  - life
  - philosophy
...
As mentioned in my post on [world approximation](/blog/an-ideal-world-approximator/), the best you can do is push your approximation, or model, of the world towards the truth via better information intake and iterating via feedback loops.
...
* You aren't perfectly rational :(
* You (hopefully) have emotions and those cloud judgment
* You are a different person at each & every moment
* You can forget things
* Every decision is different
* Your world model is inaccurate
